...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">Documentation technique</a>
                </li>
                    ...
                    <li class="chapter additional">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="additional-pages"' : 'id="xs-additional-pages"' }>
                                    <li class="chapter inner">
                                        <a data-type="chapter-link" href="additional-documentation/introduction.html" data-context-id="additional">
                                            <div class="menu-toggler linked" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#additional-page-327ae2a0b1bf40bcea69e11c211f86b4"' : 'data-target="#xs-additional-page-327ae2a0b1bf40bcea69e11c211f86b4"' }>
                                                <span class="link-name">Introduction</span>
                                                <span class="icon ion-ios-arrow-down"></span>
                                            </div>
                                        </a>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="additional-page-327ae2a0b1bf40bcea69e11c211f86b4"' : 'id="xs-additional-page-327ae2a0b1bf40bcea69e11c211f86b4"' }>
                                            <li class="link for-chapter2">
                                                <a href="additional-documentation/introduction/installation.html" data-type="entity-link" data-context="sub-entity" data-context-id="additional">Installation</a>
                                            </li>
                                        </ul>
                                    </li>
                        </ul>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' : 'data-target="#xs-components-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Composants</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' :
                                            'id="xs-components-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' }>
                                            <li class="link">
                                    ...
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#pipes-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' : 'data-target="#xs-pipes-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' }>
                                            <span class="icon ion-md-add"></span>
                                            <span>Pipes</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="pipes-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' :
                                            'id="xs-pipes-links-module-AppModule-dbd8ae0c4b45637cba217428e2d24224"' }>
                                            <li class="link">
